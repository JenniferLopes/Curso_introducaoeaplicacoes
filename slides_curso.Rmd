...
knitr::include_graphics("AGRO.jpeg")
```

```{r message=FALSE, warning=FALSE, , out.width="25%", paged.print=FALSE, echo=FALSE, fig.align = 'center'}
knitr::include_graphics("Experimento Arroz Irrigado.jpeg")
```
...
knitr::include_graphics("imagem_4.png")
```
...
.center[![Time R-Ladies Goiânia+](imagem_1.jpg)]
...
knitr::include_graphics("gif_3.gif")
```
---
# 5 Motivos para você aprender sobre o R
...
knitr::include_graphics("gif_4.gif")
```
---
class: inverse, center, middle
# 1. Ambientação no RStudio
...
```{r message=FALSE, warning=FALSE, , out.width="100%", paged.print=FALSE, echo=FALSE, fig.align = 'center'}
knitr::include_graphics("posi.png")
```
---
# 1.4 Meu primeiro script
...
```{r message=FALSE, warning=FALSE, , out.width="100%", paged.print=FALSE, echo=FALSE, fig.align = 'center'}
knitr::include_graphics("baseciencia.png")
```
...
```{r message=FALSE, warning=FALSE, , out.width="50%", paged.print=FALSE, echo=FALSE, fig.align = 'center'}
knitr::include_graphics("tipos de dados.png")
```

### **Vetores**
Eles são conjuntos de elementos do mesmo tipo, como números ou caracteres, armazenados em uma única dimensão. Podemos criar um vetor simples usando a função c().
...
knitr::include_graphics("base.jpg")
```

```{r message=FALSE, warning=FALSE, , out.width="30%", paged.print=FALSE, echo=FALSE, fig.align = 'center'}
knitr::include_graphics("funcionalidades.jpg")
```
...
1. Não use as palavras **reservadas** para nomear objetos,(evite usar número nas variáveis)
...
```{r message=FALSE, warning=FALSE, , out.width="35%", paged.print=FALSE, echo=FALSE, fig.align = 'center'}
knitr::include_graphics("funções.gif")
```
---
class: inverse, center, middle
# Vamos para prática ?
...
```{r message=FALSE, warning=FALSE, , out.width="80%", paged.print=FALSE, echo=FALSE, fig.align = 'center'}
knitr::include_graphics("ggplot.gif")
```
---
...
```{r message=FALSE, warning=FALSE, , out.width="20%", paged.print=FALSE, echo=FALSE, fig.align = 'center'}
knitr::include_graphics("ggplot2Hex.jpg")
``` 
...
```{r message=FALSE, warning=FALSE, , out.width="100%", paged.print=FALSE, echo=FALSE, fig.align = 'center'}
knitr::include_graphics("visualizacao.png")
``` 
...
```{r message=FALSE, warning=FALSE, , out.width="70%", paged.print=FALSE, echo=FALSE, fig.align = 'center'}
knitr::include_graphics("gif_6.gif")
``` 
---
# Materiais
